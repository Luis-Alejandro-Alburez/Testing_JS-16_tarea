...
for (const pokemon of pokemonList) {
  pokemon === "Yoshi" ? console.log() : console.log(`Atrapaste un ${pokemon}`);
}
ACA LO HICE CON EL  MÉTODO ABREVIADO, EL CUÁL SE VE MEJOR PERO NO PUDE USAR continue CON ESE MÉTODO  
*/
